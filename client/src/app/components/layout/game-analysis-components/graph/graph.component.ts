...
import { COLOR_FIRST_COLORS_RGB, COLOR_SECOND_COLORS_RGB, TetrominoType } from 'client/src/app/models/tetronimo-models/tetromino';
...
export class GraphComponent implements OnInit, OnChanges {
  ...
  getColorForSpeed(speed: GameSpeed): string {
    switch (speed) {
      case GameSpeed.SPEED_UNDER_18: return COLOR_FIRST_COLORS_RGB[5].toString();
      case GameSpeed.SPEED_18: return COLOR_FIRST_COLORS_RGB[8].toString();
      case GameSpeed.SPEED_19: return COLOR_SECOND_COLORS_RGB[9].toString();
      default: return COLOR_FIRST_COLORS_RGB[9].toString();
    }
  }
}
